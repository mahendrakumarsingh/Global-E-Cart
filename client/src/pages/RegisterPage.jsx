            ...
            <div className="flex w-full max-w-4xl h-[600px] bg-white rounded-3xl overflow-hidden shadow-2xl">
                ...
                <div className="hidden lg:flex w-1/2 bg-blue-600 items-center justify-center relative">
                    ...
                    <div className="relative z-20 p-8 text-white">
                        ...
                        <h1 className="text-3xl font-bold mb-4">Join the global savings community.</h1>
                        <p className="text-base text-blue-100">Create an account to access exclusive deals, track orders, and get personalized recommendations.</p>
                    </div>
                </div>
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white overflow-y-auto">
                    <div className="w-full max-w-sm">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <div className="relative">
                                    <span className="material-symbols-outlined absolute left-3 top-2.5 text-gray-400 text-sm">person</span>
                                    <input
                                        type="text"
                        ...
                        <div className="mt-6 relative flex items-center justify-center">
                            ...
                            <span className="relative bg-white px-2 text-[10px] font-bold text-gray-400 uppercase tracking-widest">Or sign up with</span>
                        </div>
